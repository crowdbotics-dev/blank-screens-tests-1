...
## Project Structure
    ...
    ├── blank_screens_tests_1  # Django project configurations
...
1. Clone this repo and `cd blank_screens_tests_1`
...
2. Clone this repo and `cd blank_screens_tests_1`
